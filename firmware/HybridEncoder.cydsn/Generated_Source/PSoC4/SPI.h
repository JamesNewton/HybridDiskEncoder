...
#define SPI_CY_SCBIP_V0    (CYIPBLOCK_m0s8scb_VERSION == 0u)
/* SCB IP block v1 is available in PSoC 4000 */
#define SPI_CY_SCBIP_V1    (CYIPBLOCK_m0s8scb_VERSION == 1u)
/* SCB IP block v2 is available in all other devices */
#define SPI_CY_SCBIP_V2    (CYIPBLOCK_m0s8scb_VERSION >= 2u)
...
#else
    #define SPI_SCB_MODE_SPI_INC  (0u)
    #define SPI_SCB_MODE_UART_INC (0u)
...
#define SPI_REMOVE_SCB_CLK     (0u)
#define SPI_SCB_CLK_INTERNAL   (0u == SPI_REMOVE_SCB_CLK)
...
/* Interface to internal interrupt component */
    ...
    *
    *******************************************************************************/
    #define SPI_EnableInt()    CyIntEnable(SPI_ISR_NUMBER)
    ...
    *
    *******************************************************************************/    
    #define SPI_DisableInt()   CyIntDisable(SPI_ISR_NUMBER)
    /** @} interrupt */

    /*******************************************************************************
    * Function Name: SPI_ClearPendingInt
    ****************************************************************************//**
    *
    *  This function clears the interrupt pending status in the NVIC. 
    *
    *******************************************************************************/
    #define SPI_ClearPendingInt()  CyIntClearPending(SPI_ISR_NUMBER)
#endif /* (SPI_SCB_IRQ_INTERNAL) */

#if (SPI_UART_RX_WAKEUP_IRQ)
    /*******************************************************************************
    * Function Name: SPI_RxWakeEnableInt
    ****************************************************************************//**
    *
    *  This function enables the interrupt (RX_WAKE) pending status in the NVIC. 
    *
    *******************************************************************************/    
    #define SPI_RxWakeEnableInt()  CyIntEnable(SPI_RX_WAKE_ISR_NUMBER)
    

    /*******************************************************************************
    * Function Name: SPI_RxWakeDisableInt
    ****************************************************************************//**
    *
    *  This function disables the interrupt (RX_WAKE) pending status in the NVIC.  
    *
    *******************************************************************************/
    #define SPI_RxWakeDisableInt() CyIntDisable(SPI_RX_WAKE_ISR_NUMBER)
    
    
    /*******************************************************************************
    * Function Name: SPI_RxWakeClearPendingInt
    ****************************************************************************//**
    *
    *  This function clears the interrupt (RX_WAKE) pending status in the NVIC. 
    *
    *******************************************************************************/    
    #define SPI_RxWakeClearPendingInt()  CyIntClearPending(SPI_RX_WAKE_ISR_NUMBER)
...
/* Get interrupt cause */
/*******************************************************************************
* Function Name: SPI_GetInterruptCause
****************************************************************************//**
*
...
*    - SPI_INTR_CAUSE_MASTER - Interrupt from Master
*    - SPI_INTR_CAUSE_SLAVE - Interrupt from Slave
*    - SPI_INTR_CAUSE_TX - Interrupt from TX
*    - SPI_INTR_CAUSE_RX - Interrupt from RX
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SPI_GetRxInterruptSource
****************************************************************************//**
*
...
*   - SPI_INTR_RX_FIFO_LEVEL - The number of data elements in the 
      RX FIFO is greater than the value of RX FIFO level.
*   - SPI_INTR_RX_NOT_EMPTY - Receiver FIFO is not empty.
*   - SPI_INTR_RX_FULL - Receiver FIFO is full.
*   - SPI_INTR_RX_OVERFLOW - Attempt to write to a full 
*     receiver FIFO.
*   - SPI_INTR_RX_UNDERFLOW - Attempt to read from an empty 
*     receiver FIFO.
*   - SPI_INTR_RX_FRAME_ERROR - UART framing error detected.
*   - SPI_INTR_RX_PARITY_ERROR - UART parity error detected.
*
*******************************************************************************/
...
*   SPI_GetRxInterruptSource() function for bit fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SPI_GetRxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_GetRxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_ClearRxInterruptSource
****************************************************************************//**
*
...
*   - SPI_INTR_RX_FIFO_LEVEL Interrupt source is not cleared when 
*     the receiver FIFO has more entries than level.
*   - SPI_INTR_RX_NOT_EMPTY Interrupt source is not cleared when
*     receiver FIFO is not empty.
*   - SPI_INTR_RX_FULL Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: SPI_SetRxInterrupt
****************************************************************************//**
*
...
*   register (refer to SPI_GetRxInterruptSource() function for bit 
*   fields values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SPI_GetTxInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - SPI_INTR_TX_FIFO_LEVEL - The number of data elements in the 
*     TX FIFO is less than the value of TX FIFO level.
*   - SPI_INTR_TX_NOT_FULL - Transmitter FIFO is not full.
*   - SPI_INTR_TX_EMPTY - Transmitter FIFO is empty.
*   - SPI_INTR_TX_OVERFLOW - Attempt to write to a full 
*     transmitter FIFO.
*   - SPI_INTR_TX_UNDERFLOW - Attempt to read from an empty 
*     transmitter FIFO.
*   - SPI_INTR_TX_UART_NACK - UART received a NACK in SmartCard 
*   mode.
*   - SPI_INTR_TX_UART_DONE - UART transfer is complete. 
*     All data elements from the TX FIFO are sent.
*   - SPI_INTR_TX_UART_ARB_LOST - Value on the TX line of the UART
...
*   SPI_GetTxInterruptSource() function for bit field values).
*
*******************************************************************************/
...
/*******************************************************************************
* Function Name: SPI_GetTxInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_GetTxInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_ClearTxInterruptSource
****************************************************************************//**
*
...
*   - SPI_INTR_TX_FIFO_LEVEL - Interrupt source is not cleared when 
*     transmitter FIFO has less entries than level.
*   - SPI_INTR_TX_NOT_FULL - Interrupt source is not cleared when
*     transmitter FIFO has empty entries.
*   - SPI_INTR_TX_EMPTY - Interrupt source is not cleared when 
*     transmitter FIFO is empty.
*   - SPI_INTR_TX_UNDERFLOW - Interrupt source is not cleared when 
...
/*******************************************************************************
* Function Name: SPI_SetTxInterrupt
****************************************************************************//**
*
*  Sets RX interrupt sources in the interrupt request register.
*
...
/*******************************************************************************
* Function Name: SPI_GetMasterInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - SPI_INTR_MASTER_SPI_DONE - SPI master transfer is complete.
*     Refer to Interrupt sources section for detailed description.
*   - SPI_INTR_MASTER_I2C_ARB_LOST - I2C master lost arbitration.
*   - SPI_INTR_MASTER_I2C_NACK - I2C master received negative 
*    acknowledgement (NAK).
*   - SPI_INTR_MASTER_I2C_ACK - I2C master received acknowledgement.
*   - SPI_INTR_MASTER_I2C_STOP - I2C master generated STOP.
*   - SPI_INTR_MASTER_I2C_BUS_ERROR - I2C master bus error 
...
/*******************************************************************************
* Function Name: SPI_SetMasterInterruptMode
****************************************************************************//**
*
...
*   SPI_GetMasterInterruptSource() function for bit field values).
*
*******************************************************************************/
#define SPI_SetMasterInterruptMode(interruptMask)  SPI_WRITE_INTR_MASTER_MASK(interruptMask)

/*******************************************************************************
* Function Name: SPI_GetMasterInterruptMode
****************************************************************************//**
*
...
*   SPI_GetMasterInterruptSource() function for return values).
*
*******************************************************************************/
#define SPI_GetMasterInterruptMode()   (SPI_INTR_MASTER_MASK_REG)

/*******************************************************************************
* Function Name: SPI_GetMasterInterruptSourceMasked
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_ClearMasterInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_SetMasterInterrupt
****************************************************************************//**
*
*  Sets Master interrupt sources in the interrupt request register.
*
*  \param interruptMask: Master interrupt sources to set in the Master interrupt
*   request register (refer to SPI_GetMasterInterruptSource() 
...
/*******************************************************************************
* Function Name: SPI_GetSlaveInterruptSource
****************************************************************************//**
*
...
*   Each constant is a bit field value. The value returned may have multiple 
*   bits set to indicate the current status.
*   - SPI_INTR_SLAVE_I2C_ARB_LOST - I2C slave lost arbitration: 
*     the value driven on the SDA line is not the same as the value observed 
*     on the SDA line.
*   - SPI_INTR_SLAVE_I2C_NACK - I2C slave received negative 
*     acknowledgement (NAK).
*   - SPI_INTR_SLAVE_I2C_ACK - I2C slave received 
*     acknowledgement (ACK).
*   - SPI_INTR_SLAVE_I2C_WRITE_STOP - Stop or Repeated Start 
*     event for write transfer intended for this slave (address matching 
*     is performed).
*   - SPI_INTR_SLAVE_I2C_STOP - Stop or Repeated Start event 
*     for (read or write) transfer intended for this slave (address matching 
*     is performed).
*   - SPI_INTR_SLAVE_I2C_START - I2C slave received Start 
*     condition.
*   - SPI_INTR_SLAVE_I2C_ADDR_MATCH - I2C slave received matching 
*     address.
*   - SPI_INTR_SLAVE_I2C_GENERAL - I2C Slave received general 
*     call address.
*   - SPI_INTR_SLAVE_I2C_BUS_ERROR - I2C slave bus error (detection 
*      of unexpected Start or Stop condition).
*   - SPI_INTR_SLAVE_SPI_BUS_ERROR - SPI slave select line is 
...
/*******************************************************************************
* Function Name: SPI_SetSlaveInterruptMode
****************************************************************************//**
*
...
*   SPI_GetSlaveInterruptSource() function for bit field values).
*
*******************************************************************************/
#define SPI_SetSlaveInterruptMode(interruptMask)   SPI_WRITE_INTR_SLAVE_MASK(interruptMask)

/*******************************************************************************
* Function Name: SPI_GetSlaveInterruptMode
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_GetSlaveInterruptSourceMasked
****************************************************************************//**
*
...
*   SPI_GetSlaveInterruptSource() function for return values).
*
*******************************************************************************/
#define SPI_GetSlaveInterruptSourceMasked()    (SPI_INTR_SLAVE_MASKED_REG)

/*******************************************************************************
* Function Name: SPI_ClearSlaveInterruptSource
****************************************************************************//**
*
...
/*******************************************************************************
* Function Name: SPI_SetSlaveInterrupt
****************************************************************************//**
*
*  Sets Slave interrupt sources in the interrupt request register.
*
*  \param interruptMask: Slave interrupt sources to set in the Slave interrupt 
*   request register (refer to SPI_GetSlaveInterruptSource() 
...
#define SPI_STATUS_PTR             ( (reg32 *) SPI_SCB__STATUS)
    ...
    #define SPI_UART_TX_CTRL_PTR       ( (reg32 *) SPI_SCB__UART_TX_CTRL)
    ...
    #define SPI_UART_FLOW_CTRL_REG     (*(reg32 *) SPI_SCB__UART_FLOW_CTRL)
    #define SPI_UART_FLOW_CTRL_PTR     ( (reg32 *) SPI_SCB__UART_FLOW_CTRL)
...
#ifdef SPI_SCB__EZ_DATA0
    #define SPI_EZBUF_DATA0_REG    (*(reg32 *) SPI_SCB__EZ_DATA0)
    #define SPI_EZBUF_DATA0_PTR    ( (reg32 *) SPI_SCB__EZ_DATA0)
#else
    #define SPI_EZBUF_DATA0_REG    (*(reg32 *) SPI_SCB__EZ_DATA00)
    #define SPI_EZBUF_DATA0_PTR    ( (reg32 *) SPI_SCB__EZ_DATA00)
#endif /* SPI_SCB__EZ_DATA00 */
...
#define SPI_FIFO_SIZE      (8u)  /* TX or RX FIFO size. */
#define SPI_EZ_DATA_NR     (32u)  /* Number of words in EZ memory. */ 
#define SPI_ONE_BYTE_WIDTH (8u)            /* Number of bits in one byte. */
#define SPI_FF_DATA_NR_LOG2_MASK       (0x0Fu)      /* Number of bits to represent a FIFO address. */
#define SPI_FF_DATA_NR_LOG2_PLUS1_MASK (0x1Fu) /* Number of bits to represent #bytes in FIFO. */
...
#if (SPI_SCB_IRQ_INTERNAL)
    #define SPI_ISR_NUMBER     ((uint8) SPI_SCB_IRQ__INTC_NUMBER)
    #define SPI_ISR_PRIORITY   ((uint8) SPI_SCB_IRQ__INTC_PRIOR_NUM)
#endif /* (SPI_SCB_IRQ_INTERNAL) */

#if (SPI_UART_RX_WAKEUP_IRQ)
    #define SPI_RX_WAKE_ISR_NUMBER     ((uint8) SPI_RX_WAKEUP_IRQ__INTC_NUMBER)
    #define SPI_RX_WAKE_ISR_PRIORITY   ((uint8) SPI_RX_WAKEUP_IRQ__INTC_PRIOR_NUM)
#endif /* (SPI_UART_RX_WAKEUP_IRQ) */
...
#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_CTRL_BYTE_MODE_POS (11u) /* [11]    Determines the number of bits per FIFO data element */
#endif /* !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */
#define SPI_CTRL_ADDR_ACCEPT_POS   (16u) /* [16]    Put matched address in RX FIFO       */
#define SPI_CTRL_BLOCK_POS         (17u) /* [17]    Ext and Int logic to resolve collide */
...
#define SPI_CTRL_EC_AM_MODE        ((uint32) 0x01u << SPI_CTRL_EC_AM_MODE_POS)
#define SPI_CTRL_EC_OP_MODE        ((uint32) 0x01u << SPI_CTRL_EC_OP_MODE_POS)
#define SPI_CTRL_EZBUF_MODE        ((uint32) 0x01u << SPI_CTRL_EZBUF_MODE_POS)
#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_CTRL_BYTE_MODE ((uint32) 0x01u << SPI_CTRL_BYTE_MODE_POS)
#endif /* !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */
#define SPI_CTRL_ADDR_ACCEPT       ((uint32) 0x01u << SPI_CTRL_ADDR_ACCEPT_POS)
#define SPI_CTRL_BLOCK             ((uint32) 0x01u << SPI_CTRL_BLOCK_POS)
#define SPI_CTRL_MODE_MASK         ((uint32) 0x03u << SPI_CTRL_MODE_POS)
#define SPI_CTRL_MODE_I2C          ((uint32) 0x00u)
#define SPI_CTRL_MODE_SPI          ((uint32) 0x01u << SPI_CTRL_MODE_POS)
#define SPI_CTRL_MODE_UART         ((uint32) 0x02u << SPI_CTRL_MODE_POS)
#define SPI_CTRL_ENABLED           ((uint32) 0x01u << SPI_CTRL_ENABLED_POS)

/* SPI_STATUS_REG */
#define SPI_STATUS_EC_BUSY_POS     (0u)  /* [0] Bus busy. Externally clocked logic access to EZ memory */
...
#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_SPI_CTRL_SCLK_CONTINUOUS_POS   (5u)  /* [5]     Enable continuous SCLK generation */
    #define SPI_SPI_CTRL_SSEL0_POLARITY_POS    (8u)  /* [8]     SS0 polarity                      */
    #define SPI_SPI_CTRL_SSEL1_POLARITY_POS    (9u)  /* [9]     SS1 polarity                      */
    #define SPI_SPI_CTRL_SSEL2_POLARITY_POS    (10u) /* [10]    SS2 polarity                      */
    #define SPI_SPI_CTRL_SSEL3_POLARITY_POS    (11u) /* [11]    SS3 polarity                      */
#endif /* !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */
#define SPI_SPI_CTRL_LOOPBACK_POS          (16u) /* [16]    Local loop-back control enabled            */
...
#define SPI_SPI_CTRL_SELECT_PRECEDE        ((uint32) 0x01u << SPI_SPI_CTRL_SELECT_PRECEDE_POS)
#define SPI_SPI_CTRL_SCLK_MODE_MASK        ((uint32) 0x03u << SPI_SPI_CTRL_CPHA_POS)
#define SPI_SPI_CTRL_CPHA                  ((uint32) 0x01u << SPI_SPI_CTRL_CPHA_POS)
#define SPI_SPI_CTRL_CPOL                  ((uint32) 0x01u << SPI_SPI_CTRL_CPOL_POS)
#define SPI_SPI_CTRL_LATE_MISO_SAMPLE      ((uint32) 0x01u << \
                                                                    SPI_SPI_CTRL_LATE_MISO_SAMPLE_POS)
#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_SPI_CTRL_SCLK_CONTINUOUS  ((uint32) 0x01u << SPI_SPI_CTRL_SCLK_CONTINUOUS_POS)
    #define SPI_SPI_CTRL_SSEL0_POLARITY   ((uint32) 0x01u << SPI_SPI_CTRL_SSEL0_POLARITY_POS)
    #define SPI_SPI_CTRL_SSEL1_POLARITY   ((uint32) 0x01u << SPI_SPI_CTRL_SSEL1_POLARITY_POS)
    #define SPI_SPI_CTRL_SSEL2_POLARITY   ((uint32) 0x01u << SPI_SPI_CTRL_SSEL2_POLARITY_POS)
    #define SPI_SPI_CTRL_SSEL3_POLARITY   ((uint32) 0x01u << SPI_SPI_CTRL_SSEL3_POLARITY_POS)
    #define SPI_SPI_CTRL_SSEL_POLARITY_MASK ((uint32)0x0Fu << SPI_SPI_CTRL_SSEL0_POLARITY_POS)
#endif /* !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */

#define SPI_SPI_CTRL_LOOPBACK              ((uint32) 0x01u << SPI_SPI_CTRL_LOOPBACK_POS)
#define SPI_SPI_CTRL_MODE_MASK             ((uint32) 0x03u << SPI_SPI_CTRL_MODE_POS)
#define SPI_SPI_CTRL_MODE_MOTOROLA         ((uint32) 0x00u)
#define SPI_SPI_CTRL_MODE_TI               ((uint32) 0x01u << SPI_CTRL_MODE_POS)
#define SPI_SPI_CTRL_MODE_NS               ((uint32) 0x02u << SPI_CTRL_MODE_POS)
#define SPI_SPI_CTRL_SLAVE_SELECT_MASK     ((uint32) 0x03u << SPI_SPI_CTRL_SLAVE_SELECT_POS)
#define SPI_SPI_CTRL_SLAVE_SELECT0         ((uint32) 0x00u)
#define SPI_SPI_CTRL_SLAVE_SELECT1         ((uint32) 0x01u << SPI_SPI_CTRL_SLAVE_SELECT_POS)
#define SPI_SPI_CTRL_SLAVE_SELECT2         ((uint32) 0x02u << SPI_SPI_CTRL_SLAVE_SELECT_POS)
#define SPI_SPI_CTRL_SLAVE_SELECT3         ((uint32) 0x03u << SPI_SPI_CTRL_SLAVE_SELECT_POS)
#define SPI_SPI_CTRL_MASTER                ((uint32) 0x01u << SPI_SPI_CTRL_MASTER_MODE_POS)
...
#define SPI_SPI_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << SPI_I2C_STATUS_EZBUF_ADDR_POS)

/* SPI_UART_CTRL */
#define SPI_UART_CTRL_LOOPBACK_POS         (16u) /* [16] Loop-back    */
#define SPI_UART_CTRL_MODE_POS             (24u) /* [24] UART subMode */
#define SPI_UART_CTRL_LOOPBACK             ((uint32) 0x01u << SPI_UART_CTRL_LOOPBACK_POS)
#define SPI_UART_CTRL_MODE_UART_STD        ((uint32) 0x00u)
#define SPI_UART_CTRL_MODE_UART_SMARTCARD  ((uint32) 0x01u << SPI_UART_CTRL_MODE_POS)
#define SPI_UART_CTRL_MODE_UART_IRDA       ((uint32) 0x02u << SPI_UART_CTRL_MODE_POS)
#define SPI_UART_CTRL_MODE_MASK            ((uint32) 0x03u << SPI_UART_CTRL_MODE_POS)
...
#define SPI_UART_TX_CTRL_PARITY                ((uint32) 0x01u << \
                                                                    SPI_UART_TX_CTRL_PARITY_POS)
#define SPI_UART_TX_CTRL_PARITY_ENABLED        ((uint32) 0x01u << \
                                                                    SPI_UART_TX_CTRL_PARITY_ENABLED_POS)
#define SPI_UART_TX_CTRL_RETRY_ON_NACK         ((uint32) 0x01u << \
                                                                    SPI_UART_TX_CTRL_RETRY_ON_NACK_POS)

/* SPI_UART_RX_CTRL */
#define SPI_UART_RX_CTRL_STOP_BITS_POS             (0u)  /* [2:0] Stop bits: (Stop bits + 1) * 0.5 period*/
...
#define SPI_UART_RX_CTRL_LIN_MODE_POS              (12u) /* [12]  Lin mode: applicable for UART Standard */
#define SPI_UART_RX_CTRL_SKIP_START_POS            (13u) /* [13]  Skip start not: only for UART Standard */
...
#define SPI_UART_RX_CTRL_PARITY                    ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_PARITY_POS)
#define SPI_UART_RX_CTRL_PARITY_ENABLED            ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_PARITY_ENABLED_POS)
#define SPI_UART_RX_CTRL_POLARITY                  ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_POLARITY_POS)
#define SPI_UART_RX_CTRL_DROP_ON_PARITY_ERR        ((uint32) 0x01u << \
                                                                   SPI_UART_RX_CTRL_DROP_ON_PARITY_ERR_POS)
#define SPI_UART_RX_CTRL_DROP_ON_FRAME_ERR         ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_DROP_ON_FRAME_ERR_POS)
#define SPI_UART_RX_CTRL_MP_MODE                   ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_MP_MODE_POS)
#define SPI_UART_RX_CTRL_LIN_MODE                  ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_LIN_MODE_POS)
#define SPI_UART_RX_CTRL_SKIP_START                ((uint32) 0x01u << \
                                                                    SPI_UART_RX_CTRL_SKIP_START_POS)
#define SPI_UART_RX_CTRL_BREAK_WIDTH_MASK          ((uint32) 0x0Fu << \
                                                                    SPI_UART_RX_CTRL_BREAK_WIDTH_POS)
/* SPI_UART_RX_STATUS_REG */
#define SPI_UART_RX_STATUS_BR_COUNTER_POS     (0u)  /* [11:0] Baud Rate counter */
#define SPI_UART_RX_STATUS_BR_COUNTER_MASK    ((uint32) 0xFFFu)

#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    /* SPI_UART_FLOW_CTRL_REG */
    #define SPI_UART_FLOW_CTRL_TRIGGER_LEVEL_POS    (0u)  /* [7:0] RTS RX FIFO trigger level         */
    #define SPI_UART_FLOW_CTRL_RTS_POLARITY_POS     (16u) /* [16]  Polarity of the RTS output signal */
    #define SPI_UART_FLOW_CTRL_CTS_POLARITY_POS     (24u) /* [24]  Polarity of the CTS input signal  */
    #define SPI_UART_FLOW_CTRL_CTS_ENABLED_POS      (25u) /* [25]  Enable CTS signal                 */
    #define SPI_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK   ((uint32) SPI_FF_DATA_NR_LOG2_MASK)
    #define SPI_UART_FLOW_CTRL_RTS_POLARITY         ((uint32) 0x01u << \
                                                                       SPI_UART_FLOW_CTRL_RTS_POLARITY_POS)
    #define SPI_UART_FLOW_CTRL_CTS_POLARITY         ((uint32) 0x01u << \
                                                                       SPI_UART_FLOW_CTRL_CTS_POLARITY_POS)
    #define SPI_UART_FLOW_CTRL_CTS_ENABLE           ((uint32) 0x01u << \
                                                                       SPI_UART_FLOW_CTRL_CTS_ENABLED_POS)
#endif /* !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */

/* SPI_I2C_CTRL */
#define SPI_I2C_CTRL_HIGH_PHASE_OVS_POS           (0u)   /* [3:0] Oversampling factor high: master only */
#define SPI_I2C_CTRL_LOW_PHASE_OVS_POS            (4u)   /* [7:4] Oversampling factor low:  master only */
#define SPI_I2C_CTRL_M_READY_DATA_ACK_POS         (8u)   /* [8]   Master ACKs data while RX FIFO != FULL*/
...
#define SPI_I2C_CTRL_LOOPBACK_POS                 (16u)  /* [16]  Loop-back                             */
...
#define SPI_I2C_CTRL_LOW_PHASE_OVS_MASK   ((uint32) 0x0Fu << \
                                                                SPI_I2C_CTRL_LOW_PHASE_OVS_POS)
#define SPI_I2C_CTRL_M_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_M_READY_DATA_ACK_POS)
#define SPI_I2C_CTRL_M_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_M_NOT_READY_DATA_NACK_POS)
#define SPI_I2C_CTRL_S_GENERAL_IGNORE      ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_S_GENERAL_IGNORE_POS)
#define SPI_I2C_CTRL_S_READY_ADDR_ACK      ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_S_READY_ADDR_ACK_POS)
#define SPI_I2C_CTRL_S_READY_DATA_ACK      ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_S_READY_DATA_ACK_POS)
#define SPI_I2C_CTRL_S_NOT_READY_ADDR_NACK ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_S_NOT_READY_ADDR_NACK_POS)
#define SPI_I2C_CTRL_S_NOT_READY_DATA_NACK ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_S_NOT_READY_DATA_NACK_POS)
#define SPI_I2C_CTRL_LOOPBACK              ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_LOOPBACK_POS)
#define SPI_I2C_CTRL_SLAVE_MODE            ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_SLAVE_MODE_POS)
#define SPI_I2C_CTRL_MASTER_MODE           ((uint32) 0x01u << \
                                                                SPI_I2C_CTRL_MASTER_MODE_POS)
#define SPI_I2C_CTRL_SLAVE_MASTER_MODE_MASK    ((uint32) 0x03u << \
                                                                SPI_I2C_CTRL_SLAVE_MODE_POS)
...
#define SPI_I2C_STATUS_S_READ          ((uint32) 0x01u << SPI_I2C_STATUS_S_READ_POS)
#define SPI_I2C_STATUS_M_READ          ((uint32) 0x01u << SPI_I2C_STATUS_M_READ_POS)
#define SPI_I2C_STATUS_EZBUF_ADDR_MASK ((uint32) 0xFFu << SPI_I2C_STATUS_EZBUF_ADDR_POS)
...
#define SPI_I2C_MASTER_CMD_M_START_ON_IDLE ((uint32) 0x01u << \
                                                                   SPI_I2C_MASTER_CMD_M_START_ON_IDLE_POS)
#define SPI_I2C_MASTER_CMD_M_ACK           ((uint32) 0x01u << \
                                                                   SPI_I2C_MASTER_CMD_M_ACK_POS)
#define SPI_I2C_MASTER_CMD_M_NACK          ((uint32) 0x01u << \
                                                                    SPI_I2C_MASTER_CMD_M_NACK_POS)
#define SPI_I2C_MASTER_CMD_M_STOP          ((uint32) 0x01u << \
...
#define SPI_I2C_SLAVE_CMD_S_NACK       ((uint32) 0x01u << SPI_I2C_SLAVE_CMD_S_NACK_POS)
...
#define SPI_I2C_CFG_SDA_FILT_OUT_HS_POS        (26u) /* [26]    '0': 50 ns filter, '1': 10 ns filter     */
#define SPI_I2C_CFG_SDA_FILT_OUT_ENABLED_POS   (27u) /* [27]    I2C SDA output delay filter enabled      */
#define SPI_I2C_CFG_SDA_FILT_HYS_MASK          ((uint32) 0x03u)
#define SPI_I2C_CFG_SDA_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                SPI_I2C_CFG_SDA_FILT_TRIM_POS)
#define SPI_I2C_CFG_SCL_FILT_HYS_MASK          ((uint32) 0x03u << \
                                                                SPI_I2C_CFG_SCL_FILT_HYS_POS)
#define SPI_I2C_CFG_SCL_FILT_TRIM_MASK         ((uint32) 0x03u << \
                                                                SPI_I2C_CFG_SCL_FILT_TRIM_POS)
#define SPI_I2C_CFG_SDA_FILT_OUT_HYS_MASK      ((uint32) 0x03u << \
                                                                SPI_I2C_CFG_SDA_FILT_OUT_HYS_POS)
#define SPI_I2C_CFG_SDA_FILT_OUT_TRIM_MASK     ((uint32) 0x03u << \
                                                                SPI_I2C_CFG_SDA_FILT_OUT_TRIM_POS)
#define SPI_I2C_CFG_SDA_FILT_HS                ((uint32) 0x01u << \
                                                                SPI_I2C_CFG_SDA_FILT_HS_POS)
#define SPI_I2C_CFG_SDA_FILT_ENABLED           ((uint32) 0x01u << \
                                                                SPI_I2C_CFG_SDA_FILT_ENABLED_POS)
#define SPI_I2C_CFG_SCL_FILT_HS                ((uint32) 0x01u << \
                                                                SPI_I2C_CFG_SCL_FILT_HS_POS)
#define SPI_I2C_CFG_SCL_FILT_ENABLED           ((uint32) 0x01u << \
                                                                SPI_I2C_CFG_SCL_FILT_ENABLED_POS)
#define SPI_I2C_CFG_SDA_FILT_OUT_HS            ((uint32) 0x01u << \
                                                                SPI_I2C_CFG_SDA_FILT_OUT_HS_POS)
#define SPI_I2C_CFG_SDA_FILT_OUT_ENABLED       ((uint32) 0x01u << \
                                                                SPI_I2C_CFG_SDA_FILT_OUT_ENABLED_POS)
#else
#define SPI_I2C_CFG_SDA_IN_FILT_TRIM_POS   (0u)  /* [1:0] Trim bits for "i2c_sda_in" 50 ns filter */
#define SPI_I2C_CFG_SDA_IN_FILT_SEL_POS    (4u)  /* [4]   "i2c_sda_in" filter delay: 0 ns and 50 ns */
#define SPI_I2C_CFG_SCL_IN_FILT_TRIM_POS   (8u)  /* [9:8] Trim bits for "i2c_scl_in" 50 ns filter */
#define SPI_I2C_CFG_SCL_IN_FILT_SEL_POS    (12u) /* [12]  "i2c_scl_in" filter delay: 0 ns and 50 ns */
#define SPI_I2C_CFG_SDA_OUT_FILT0_TRIM_POS (16u) /* [17:16] Trim bits for "i2c_sda_out" 50 ns filter 0 */
#define SPI_I2C_CFG_SDA_OUT_FILT1_TRIM_POS (18u) /* [19:18] Trim bits for "i2c_sda_out" 50 ns filter 1 */
#define SPI_I2C_CFG_SDA_OUT_FILT2_TRIM_POS (20u) /* [21:20] Trim bits for "i2c_sda_out" 50 ns filter 2 */
#define SPI_I2C_CFG_SDA_OUT_FILT_SEL_POS   (28u) /* [29:28] Cumulative "i2c_sda_out" filter delay: */

#define SPI_I2C_CFG_SDA_IN_FILT_TRIM_MASK  ((uint32) 0x03u)
#define SPI_I2C_CFG_SDA_IN_FILT_SEL        ((uint32) 0x01u << SPI_I2C_CFG_SDA_IN_FILT_SEL_POS)
#define SPI_I2C_CFG_SCL_IN_FILT_TRIM_MASK  ((uint32) 0x03u << \
                                                            SPI_I2C_CFG_SCL_IN_FILT_TRIM_POS)
#define SPI_I2C_CFG_SCL_IN_FILT_SEL        ((uint32) 0x01u << SPI_I2C_CFG_SCL_IN_FILT_SEL_POS)
#define SPI_I2C_CFG_SDA_OUT_FILT0_TRIM_MASK ((uint32) 0x03u << \
                                                            SPI_I2C_CFG_SDA_OUT_FILT0_TRIM_POS)
#define SPI_I2C_CFG_SDA_OUT_FILT1_TRIM_MASK ((uint32) 0x03u << \
                                                            SPI_I2C_CFG_SDA_OUT_FILT1_TRIM_POS)
#define SPI_I2C_CFG_SDA_OUT_FILT2_TRIM_MASK ((uint32) 0x03u << \
                                                            SPI_I2C_CFG_SDA_OUT_FILT2_TRIM_POS)
#define SPI_I2C_CFG_SDA_OUT_FILT_SEL_MASK   ((uint32) 0x03u << \
                                                            SPI_I2C_CFG_SDA_OUT_FILT_SEL_POS)
#endif /* (SPI_CY_SCBIP_V0) */


/* SPI_TX_CTRL_REG */
#define SPI_TX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define SPI_TX_CTRL_MSB_FIRST          ((uint32) 0x01u << SPI_TX_CTRL_MSB_FIRST_POS)
#define SPI_TX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define SPI_TX_CTRL_ENABLED            ((uint32) 0x01u << SPI_TX_CTRL_ENABLED_POS)

/* SPI_TX_CTRL_FIFO_REG */
#define SPI_TX_FIFO_CTRL_TRIGGER_LEVEL_POS     (0u)  /* [2:0] Trigger level                              */
#define SPI_TX_FIFO_CTRL_CLEAR_POS             (16u) /* [16]  Clear TX FIFO: cleared after set           */
#define SPI_TX_FIFO_CTRL_FREEZE_POS            (17u) /* [17]  Freeze TX FIFO: HW do not inc read pointer */
#define SPI_TX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) SPI_FF_DATA_NR_LOG2_MASK)
#define SPI_TX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << SPI_TX_FIFO_CTRL_CLEAR_POS)
#define SPI_TX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << SPI_TX_FIFO_CTRL_FREEZE_POS)
...
#define SPI_TX_FIFO_STATUS_USED_MASK   ((uint32) SPI_FF_DATA_NR_LOG2_PLUS1_MASK)
#define SPI_TX_FIFO_SR_VALID           ((uint32) 0x01u << SPI_TX_FIFO_SR_VALID_POS)
#define SPI_TX_FIFO_STATUS_RD_PTR_MASK ((uint32) SPI_FF_DATA_NR_LOG2_MASK << \
                                                                    SPI_TX_FIFO_STATUS_RD_PTR_POS)
#define SPI_TX_FIFO_STATUS_WR_PTR_MASK ((uint32) SPI_FF_DATA_NR_LOG2_MASK << \
...
/* SPI_RX_CTRL_REG */
#define SPI_RX_CTRL_DATA_WIDTH_POS     (0u)  /* [3:0] Data frame width: (Data width - 1) */
...
#define SPI_RX_CTRL_MSB_FIRST          ((uint32) 0x01u << SPI_RX_CTRL_MSB_FIRST_POS)
#define SPI_RX_CTRL_LSB_FIRST          ((uint32) 0x00u)
#define SPI_RX_CTRL_MEDIAN             ((uint32) 0x01u << SPI_RX_CTRL_MEDIAN_POS)
#define SPI_RX_CTRL_ENABLED            ((uint32) 0x01u << SPI_RX_CTRL_ENABLED_POS)


/* SPI_RX_FIFO_CTRL_REG */
#define SPI_RX_FIFO_CTRL_TRIGGER_LEVEL_POS     (0u)   /* [2:0] Trigger level                            */
#define SPI_RX_FIFO_CTRL_CLEAR_POS             (16u)  /* [16]  Clear RX FIFO: clear after set           */
#define SPI_RX_FIFO_CTRL_FREEZE_POS            (17u)  /* [17]  Freeze RX FIFO: HW writes has not effect */
#define SPI_RX_FIFO_CTRL_TRIGGER_LEVEL_MASK    ((uint32) SPI_FF_DATA_NR_LOG2_MASK)
#define SPI_RX_FIFO_CTRL_CLEAR                 ((uint32) 0x01u << SPI_RX_FIFO_CTRL_CLEAR_POS)
#define SPI_RX_FIFO_CTRL_FREEZE                ((uint32) 0x01u << SPI_RX_FIFO_CTRL_FREEZE_POS)
...
#define SPI_RX_FIFO_STATUS_USED_MASK   ((uint32) SPI_FF_DATA_NR_LOG2_PLUS1_MASK)
#define SPI_RX_FIFO_SR_VALID           ((uint32) 0x01u << SPI_RX_FIFO_SR_VALID_POS)
#define SPI_RX_FIFO_STATUS_RD_PTR_MASK ((uint32) SPI_FF_DATA_NR_LOG2_MASK << \
                                                                    SPI_RX_FIFO_STATUS_RD_PTR_POS)
#define SPI_RX_FIFO_STATUS_WR_PTR_MASK ((uint32) SPI_FF_DATA_NR_LOG2_MASK << \
...
#define SPI_RX_MATCH_MASK_MASK    ((uint32) 0xFFu << SPI_RX_MATCH_MASK_POS)
...
#define SPI_INTR_CAUSE_SLAVE       ((uint32) 0x01u << SPI_INTR_CAUSE_SLAVE_POS)
#define SPI_INTR_CAUSE_TX          ((uint32) 0x01u << SPI_INTR_CAUSE_TX_POS)
#define SPI_INTR_CAUSE_RX          ((uint32) 0x01u << SPI_INTR_CAUSE_RX_POS)
#define SPI_INTR_CAUSE_I2C_EC      ((uint32) 0x01u << SPI_INTR_CAUSE_I2C_EC_POS)
#define SPI_INTR_CAUSE_SPI_EC      ((uint32) 0x01u << SPI_INTR_CAUSE_SPI_EC_POS)
...
#define SPI_INTR_SPI_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    SPI_INTR_SPI_EC_EZBUF_STOP_POS)
#define SPI_INTR_SPI_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define SPI_INTR_I2C_EC_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    SPI_INTR_I2C_EC_EZBUF_STOP_POS)
#define SPI_INTR_I2C_EC_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
...
#define SPI_INTR_MASTER_SPI_DONE_POS       (9u)  /* [9] Master complete transfer: Only for SPI           */
#define SPI_INTR_MASTER_I2C_ARB_LOST       ((uint32) 0x01u)
#define SPI_INTR_MASTER_I2C_NACK           ((uint32) 0x01u << SPI_INTR_MASTER_I2C_NACK_POS)
#define SPI_INTR_MASTER_I2C_ACK            ((uint32) 0x01u << SPI_INTR_MASTER_I2C_ACK_POS)
#define SPI_INTR_MASTER_I2C_STOP           ((uint32) 0x01u << SPI_INTR_MASTER_I2C_STOP_POS)
#define SPI_INTR_MASTER_I2C_BUS_ERROR      ((uint32) 0x01u << \
                                                                    SPI_INTR_MASTER_I2C_BUS_ERROR_POS)
#define SPI_INTR_MASTER_SPI_DONE           ((uint32) 0x01u << SPI_INTR_MASTER_SPI_DONE_POS)
...
#define SPI_INTR_SLAVE_I2C_STOP_POS             (4u)  /* [4]  Slave detects end of transaction intended */
...
#define SPI_INTR_SLAVE_SPI_EZBUF_STOP_POS       (10u) /* [10] Slave end of transaction: Only for SPI   */
...
#define SPI_INTR_SLAVE_I2C_NACK                 ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_NACK_POS)
#define SPI_INTR_SLAVE_I2C_ACK                  ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_ACK_POS)
#define SPI_INTR_SLAVE_I2C_WRITE_STOP           ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_WRITE_STOP_POS)
#define SPI_INTR_SLAVE_I2C_STOP                 ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_STOP_POS)
#define SPI_INTR_SLAVE_I2C_START                ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_START_POS)
#define SPI_INTR_SLAVE_I2C_ADDR_MATCH           ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_ADDR_MATCH_POS)
#define SPI_INTR_SLAVE_I2C_GENERAL              ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_GENERAL_POS)
#define SPI_INTR_SLAVE_I2C_BUS_ERROR            ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_I2C_BUS_ERROR_POS)
#define SPI_INTR_SLAVE_SPI_EZBUF_WRITE_STOP     ((uint32) 0x01u << \
                                                                   SPI_INTR_SLAVE_SPI_EZBUF_WRITE_STOP_POS)
#define SPI_INTR_SLAVE_SPI_EZBUF_STOP           ((uint32) 0x01u << \
                                                                    SPI_INTR_SLAVE_SPI_EZBUF_STOP_POS)
#define SPI_INTR_SLAVE_SPI_BUS_ERROR           ((uint32) 0x01u << \
...
#define SPI_INTR_TX_FIFO_LEVEL         (SPI_INTR_TX_TRIGGER)
#define SPI_INTR_TX_NOT_FULL           ((uint32) 0x01u << SPI_INTR_TX_NOT_FULL_POS)
#define SPI_INTR_TX_EMPTY              ((uint32) 0x01u << SPI_INTR_TX_EMPTY_POS)
#define SPI_INTR_TX_OVERFLOW           ((uint32) 0x01u << SPI_INTR_TX_OVERFLOW_POS)
#define SPI_INTR_TX_UNDERFLOW          ((uint32) 0x01u << SPI_INTR_TX_UNDERFLOW_POS)
#define SPI_INTR_TX_BLOCKED            ((uint32) 0x01u << SPI_INTR_TX_BLOCKED_POS)
#define SPI_INTR_TX_UART_NACK          ((uint32) 0x01u << SPI_INTR_TX_UART_NACK_POS)
#define SPI_INTR_TX_UART_DONE          ((uint32) 0x01u << SPI_INTR_TX_UART_DONE_POS)
#define SPI_INTR_TX_UART_ARB_LOST      ((uint32) 0x01u << SPI_INTR_TX_UART_ARB_LOST_POS)
...
#define SPI_INTR_RX_BAUD_DETECT_POS    (10u)  /* [10] LIN baud rate detection is completed   */
#define SPI_INTR_RX_BREAK_DETECT_POS   (11u)  /* [11] Break detection is successful         */
#define SPI_INTR_RX_TRIGGER            ((uint32) 0x01u)
#define SPI_INTR_RX_FIFO_LEVEL         (SPI_INTR_RX_TRIGGER)
#define SPI_INTR_RX_NOT_EMPTY          ((uint32) 0x01u << SPI_INTR_RX_NOT_EMPTY_POS)
#define SPI_INTR_RX_FULL               ((uint32) 0x01u << SPI_INTR_RX_FULL_POS)
#define SPI_INTR_RX_OVERFLOW           ((uint32) 0x01u << SPI_INTR_RX_OVERFLOW_POS)
#define SPI_INTR_RX_UNDERFLOW          ((uint32) 0x01u << SPI_INTR_RX_UNDERFLOW_POS)
#define SPI_INTR_RX_BLOCKED            ((uint32) 0x01u << SPI_INTR_RX_BLOCKED_POS)
#define SPI_INTR_RX_FRAME_ERROR        ((uint32) 0x01u << SPI_INTR_RX_FRAME_ERROR_POS)
#define SPI_INTR_RX_PARITY_ERROR       ((uint32) 0x01u << SPI_INTR_RX_PARITY_ERROR_POS)
#define SPI_INTR_RX_BAUD_DETECT        ((uint32) 0x01u << SPI_INTR_RX_BAUD_DETECT_POS)
#define SPI_INTR_RX_BREAK_DETECT       ((uint32) 0x01u << SPI_INTR_RX_BREAK_DETECT_POS)
...
/* Write interrupt source: set sourceMask bits in SPI_INTR_X_MASK_REG */
...
/* Enable interrupt source: set sourceMask bits in SPI_INTR_X_MASK_REG */
...
/* Disable interrupt source: clear sourceMask bits in SPI_INTR_X_MASK_REG */
...
/* Set interrupt sources: write sourceMask bits in SPI_INTR_X_SET_REG */
...
/* Clear interrupt sources: write sourceMask bits in SPI_INTR_X_REG */
...
#define SPI_CHECK_INTR_I2C_EC(sourceMask)  (0u != (SPI_INTR_I2C_EC_REG & (sourceMask)))
#if (!SPI_CY_SCBIP_V1)
    #define SPI_CHECK_INTR_SPI_EC(sourceMask)  (0u != (SPI_INTR_SPI_EC_REG & (sourceMask)))
#endif /* (!SPI_CY_SCBIP_V1) */
...
/* Return true if sourceMask is set in SPI_CTRL_REG: generally is used to check enable bit */
...
#define SPI_I2C_SLAVE_GENERATE_ACK \
    ...
    #define SPI_I2C_SLAVE_GENERATE_NACK SPI_I2CSlaveNackGeneration()
...
#define SPI_I2C_SLAVE_CLEAR_NACK \
                            do{               \
                                SPI_I2C_SLAVE_CMD_REG = 0u; \
                            }while(0)
...
#define SPI_DIGITAL_FILTER_DISABLE    (0u)
#define SPI_DIGITAL_FILTER_ENABLE     (1u)
#define SPI_I2C_DATA_RATE_FS_MODE_MAX (400u)
#if (SPI_CY_SCBIP_V0)
    /* SPI_I2C_CFG_SDA_FILT_OUT_ENABLED is disabled by default */
    #define SPI_I2C_CFG_FILT_MASK  (SPI_I2C_CFG_SDA_FILT_ENABLED | \
                                                 SPI_I2C_CFG_SCL_FILT_ENABLED)
#else
    /* SPI_I2C_CFG_SDA_OUT_FILT_SEL_MASK is disabled by default */
    #define SPI_I2C_CFG_FILT_MASK  (SPI_I2C_CFG_SDA_IN_FILT_SEL | \
                                                 SPI_I2C_CFG_SCL_IN_FILT_SEL)
#endif /* (SPI_CY_SCBIP_V0) */

#define SPI_I2C_CFG_ANALOG_FITER_DISABLE \
        do{                                           \
            SPI_I2C_CFG_REG &= (uint32) ~SPI_I2C_CFG_FILT_MASK; \
        }while(0)

#define SPI_I2C_CFG_ANALOG_FITER_ENABLE \
        do{                                          \
            SPI_I2C_CFG_REG |= (uint32)  SPI_I2C_CFG_FILT_MASK; \
        }while(0)
...
/* Return true if bit is set in SPI_I2C_STATUS_REG */
#define SPI_CHECK_I2C_STATUS(sourceMask)   (0u != (SPI_I2C_STATUS_REG & (sourceMask)))

/* Return true if bit is set in SPI_SPI_STATUS_REG */
#define SPI_CHECK_SPI_STATUS(sourceMask)   (0u != (SPI_SPI_STATUS_REG & (sourceMask)))

/* Return FIFO size depends on SPI_CTRL_BYTE_MODE bit */
#define SPI_GET_FIFO_SIZE(condition) ((0u != (condition)) ? \
                                                    (2u * SPI_FIFO_SIZE) : (SPI_FIFO_SIZE))
...
#if (SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_GET_CTRL_BYTE_MODE(mode)   (0u)
#else
    #define SPI_GET_CTRL_BYTE_MODE(mode)   ((0u != (mode)) ? \
                                                            (SPI_CTRL_BYTE_MODE) : (0u))
#endif /* (SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */
...
#define SPI_GET_I2C_CTRL_LOW_PHASE_OVS(oversampleLow)  ((((uint32) (oversampleLow) - 1u) << \
                                                                    SPI_I2C_CTRL_LOW_PHASE_OVS_POS) &  \
...
#define SPI_GET_I2C_CTRL_S_GENERAL_IGNORE(genCall) ((0u != (genCall)) ? \
                                                                    (SPI_I2C_CTRL_S_GENERAL_IGNORE) : (0u))

#define SPI_GET_I2C_CTRL_SL_MSTR_MODE(mode)    ((uint32)(mode) << SPI_I2C_CTRL_SLAVE_MODE_POS)
...
#define SPI_GET_SPI_CTRL_SCLK_MODE(mode)       (((uint32) (mode) << \
...
#if (SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) (0u)
    #define SPI_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (0u)
#else
    #define SPI_GET_SPI_CTRL_SCLK_CONTINUOUS(sclkType) ((0u != (sclkType)) ? \
                                                                    (SPI_SPI_CTRL_SCLK_CONTINUOUS) : (0u))

    #define SPI_GET_SPI_CTRL_SSEL_POLARITY(polarity)   (((uint32) (polarity) << \
                                                                     SPI_SPI_CTRL_SSEL0_POLARITY_POS) & \
                                                                     SPI_SPI_CTRL_SSEL_POLARITY_MASK)
#endif /* ((SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */

#define SPI_GET_SPI_CTRL_SUB_MODE(mode)        (((uint32) (mode) << SPI_SPI_CTRL_MODE_POS) & \
                                                                                 SPI_SPI_CTRL_MODE_MASK)

#define SPI_GET_SPI_CTRL_SLAVE_SELECT(select)  (((uint32) (select) << \
                                                                      SPI_SPI_CTRL_SLAVE_SELECT_POS) & \
                                                                      SPI_SPI_CTRL_SLAVE_SELECT_MASK)
...
/* SPI_UART_CTRL */
#define SPI_GET_UART_CTRL_MODE(mode)           (((uint32) (mode) << \
...
/* SPI_UART_FLOW_CTRL */
#if !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
    #define SPI_GET_UART_FLOW_CTRL_TRIGGER_LEVEL(level)   ( (uint32) (level) & \
                                                                 SPI_UART_FLOW_CTRL_TRIGGER_LEVEL_MASK)

    #define SPI_GET_UART_FLOW_CTRL_RTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (SPI_UART_FLOW_CTRL_RTS_POLARITY) : (0u))

    #define SPI_GET_UART_FLOW_CTRL_CTS_POLARITY(polarity) ((0u != (polarity)) ? \
                                                                (SPI_UART_FLOW_CTRL_CTS_POLARITY) : (0u))

    #define SPI_GET_UART_FLOW_CTRL_CTS_ENABLE(ctsEn)      ((0u != (ctsEn)) ? \
                                                                (SPI_UART_FLOW_CTRL_CTS_ENABLE) : (0u))
#endif /* !(SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1) */
...
#define SPI_GET_RX_MATCH_MASK(mask)    (((uint32) (mask) << \
...
/* SPI_INTR_SLAVE_I2C_GENERAL */
#define SPI_GET_INTR_SLAVE_I2C_GENERAL(genCall)  ((0u != (genCall)) ? \
                                                                (SPI_INTR_SLAVE_I2C_GENERAL) : (0u))

/* Return true if master mode is enabled SPI_SPI_CTRL_REG */
#define SPI_CHECK_SPI_MASTER   (0u != (SPI_SPI_CTRL_REG & SPI_SPI_CTRL_MASTER))

/* Return inactive state of SPI SCLK line depends on CPOL */
#define SPI_GET_SPI_SCLK_INACTIVE \
            ((0u == (SPI_SPI_CTRL_REG & SPI_SPI_CTRL_CPOL)) ? (0u) : (1u))

/* Get output pin inactive state */
#if (SPI_CY_SCBIP_V0 || SPI_CY_SCBIP_V1)
#define SPI_GET_SPI_SS0_INACTIVE       (1u)
#define SPI_GET_SPI_SS1_INACTIVE       (1u)
#define SPI_GET_SPI_SS2_INACTIVE       (1u)
#define SPI_GET_SPI_SS3_INACTIVE       (1u)
#define SPI_GET_UART_RTS_INACTIVE      (1u)

#else
#define SPI_GET_SPI_SS0_INACTIVE  \
        ((0u != (SPI_SPI_CTRL_REG & SPI_SPI_CTRL_SSEL0_POLARITY)) ? (0u) : (1u))

#define SPI_GET_SPI_SS1_INACTIVE  \
        ((0u != (SPI_SPI_CTRL_REG & SPI_SPI_CTRL_SSEL1_POLARITY)) ? (0u) : (1u))

#define SPI_GET_SPI_SS2_INACTIVE  \
        ((0u != (SPI_SPI_CTRL_REG & SPI_SPI_CTRL_SSEL2_POLARITY)) ? (0u) : (1u))

#define SPI_GET_SPI_SS3_INACTIVE  \
        ((0u != (SPI_SPI_CTRL_REG & SPI_SPI_CTRL_SSEL3_POLARITY)) ? (0u) : (1u))

#define SPI_GET_UART_RTS_INACTIVE \
        ((0u == (SPI_UART_FLOW_CTRL_REG & SPI_UART_FLOW_CTRL_RTS_POLARITY)) ? (0u) : (1u))
...
#define SPI_CHECK_INTR_EC_I2C(sourceMask)  SPI_CHECK_INTR_I2C_EC(sourceMask)
#if (!SPI_CY_SCBIP_V1)
    #define SPI_CHECK_INTR_EC_SPI(sourceMask)  SPI_CHECK_INTR_SPI_EC(sourceMask)
#endif /* (!SPI_CY_SCBIP_V1) */

#define SPI_CY_SCBIP_V1_I2C_ONLY   (SPI_CY_SCBIP_V1)
#define SPI_EZBUFFER_SIZE          (SPI_EZ_DATA_NR)

#define SPI_EZBUF_DATA00_REG   SPI_EZBUF_DATA0_REG
#define SPI_EZBUF_DATA00_PTR   SPI_EZBUF_DATA0_PTR
